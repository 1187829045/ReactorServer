...
CXXFLAGS = -Wall -std=c++11 -Isocket   # ✅ 指定头文件目录
# 目录
CLIENT_DIR = client
SERVER_DIR = server
...
SERVER_SRC = $(SERVER_DIR)/tcpepoll.cpp $(INET_DIR)/inet_address.cpp  $(SOCK_DIR)/socket.cpp $(EPOLL_DIR)/epoll.cpp  # ✅ 添加 inet_address 源文件
